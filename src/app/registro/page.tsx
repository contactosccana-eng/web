...
export default function RegistroPage() {
  ...
  // El texto exacto con el formato provisto por el usuario
  const bankDataText = `Registro Comuarica
8988401-2
Banco de Chile
Cuenta Vista
00-028-51240-58
monardesdebra@gmail.com`;
  ...
  return (
    <div className="registro-wrapper">
      {/* Estilos CSS Inline de alto nivel optimizados con estética turquesa premium */}
      <style dangerouslySetInnerHTML={{ __html: `
        .registro-wrapper {
          min-height: 100vh;
          background: radial-gradient(circle at top right, rgba(13, 148, 136, 0.18), transparent 40%),
                      radial-gradient(circle at bottom left, rgba(15, 23, 42, 1), #050a0d);
      ...
      <div className="registro-container">
        ...
        {/* Encabezado con badge temática de registro */}
        <div className="registro-badge">
          <svg className="registro-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <h1 className="registro-title">Registro ComuArica</h1>
        <p className="registro-subtitle">
          Copia los datos bancarios exactos a continuación para realizar tu transferencia de registro.
        </p>
        ...
        <div className="glass-card">
          ...
          <button 
            ...
            onClick={handleCopy}
            aria-label="Copiar datos bancarios para registro"
          >
            {copied ? (
              <>
