  ...
  return (
    <div className="donar-wrapper">
      ...
      <div className="donar-container">
        ...
        {/* Encabezado con badge temática de generosidad */}
        <div className="donar-badge">
          <svg className="donar-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
            <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path>
          </svg>
          Generosidad Comuarica
        </div>
        ...
        <div className="glass-card">
          ...
          <button 
            ...
            onClick={handleCopy}
            aria-label="Copiar datos bancarios para donar"
          >
            {copied ? (
              <>
